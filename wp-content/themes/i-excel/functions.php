...
function iexcel_scripts_styles() {
	...
	wp_enqueue_style( 'iexcel-style', get_stylesheet_uri(), array(), '2015-07-18' );
	...
	wp_enqueue_style( 'iexcel-ie', get_template_directory_uri() . '/css/ie.css', array( 'iexcel-style' ), '2015-07-18' );
	wp_style_add_data( 'iexcel-ie', 'conditional', 'lt IE 9' );
	
	
	wp_enqueue_style( 'i-excel-extra-stylesheet', get_template_directory_uri() . '/css/extra-style.css', array(), '2015-03-11' );
...
function iexcel_layout_body_class( $classes ) {
	...
	if ( get_theme_mod('wide_layout', '0') != 0 )
	{
		$classes[] = 'nx-wide';		
	} else
	{
